		...
		if ($result['is_admin']>=1) {
			echo'	<ul class="chat"><li class="right clearfix">
						<span class="chat-img pull-right">
                        	<img src="https://placehold.it/50/FA6F57/fff&amp;text=ADMIN" alt="Admin Avatar" class="img-circle">
                    	</span>
			...
			echo'<li class="left clearfix">
					<span class="chat-img pull-left">
						<img src="https://placehold.it/50/55C1E7/fff&amp;text=P" alt="Player Avatar" class="img-circle">
					</span>
                	<div class="chat-body clearfix">
                		<div class="header">
